...
// Source: internal/infrastructure/config/configUser.go
...
// GetAppleClientId mocks base method.
func (m *MockUser) GetAppleClientId() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAppleClientId")
	ret0, _ := ret[0].(string)
	return ret0
}

// GetAppleClientId indicates an expected call of GetAppleClientId.
func (mr *MockUserMockRecorder) GetAppleClientId() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAppleClientId", reflect.TypeOf((*MockUser)(nil).GetAppleClientId))
}

// GetGoogleClientId mocks base method.
func (m *MockUser) GetGoogleClientId() string {
	m.ctrl.T.Helper()
...
func (mr *MockUserMockRecorder) GetGoogleClientId() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetGoogleClientId", reflect.TypeOf((*MockUser)(nil).GetGoogleClientId))
}
...
// GetMicrosoftClientId mocks base method.
func (m *MockUser) GetMicrosoftClientId() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMicrosoftClientId")
	ret0, _ := ret[0].(string)
	return ret0
}

// GetMicrosoftClientId indicates an expected call of GetMicrosoftClientId.
func (mr *MockUserMockRecorder) GetMicrosoftClientId() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMicrosoftClientId", reflect.TypeOf((*MockUser)(nil).GetMicrosoftClientId))
}
