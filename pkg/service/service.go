...
type User interface {
	GetUserByUserid(ctx context.Context, userid int) (types.User, error)
	...
	GetUserActivationByToken(ctx context.Context, token string) (types.UserActivationToken, error)
	...
	GetRefreshTokenData(ctx context.Context, userid int, token string) (types.UserRefreshToken, error)
}
